...
namespace AzureCosmosDB
{
    class Program
    {
        private static readonly string EndpointUri = "https://sqlcosmos111.documents.azure.com:443";
        // The primary key for the Azure Cosmos account.
        private static readonly string PrimaryKey = "aULr1s07gMJu8jRKFexAMn7KdZiz4LC8C2zCyjW53ldKpumDxkTCbrDFKi4nPH9EZHaMgt90HmJjBBK5mTV61Q==";
        ...
        static void Main(string[] args)
        {
            ...
            P.GetStartedDemoAsync().GetAwaiter();
            Console.ReadLine();
        }
        ...
        private async Task ViewDatabases()
        {
        ...
        private async Task ViewContainer()
        {
            var database = this.cosmosClient.GetDatabase("FamilyDatabase");
            var Iterator = database.GetContainerQueryIterator<ContainerProperties>();
            var Containers = await Iterator.ReadNextAsync();

            int Count = 0;

            foreach(var Counter in Containers)
            {
                Count++;
                Console.WriteLine($"Container ID : {Counter.Id}");
            }
